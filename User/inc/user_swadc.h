...
#define USER__ADC_POLL_DATA_LENGTH 3
#define USER__ADC_POLL_DATA_COUNT (USER__ADC_POLL_DATA_LENGTH * USER__SW_COUNT)
#define USER__ADC_POLL_SERVICE_COMMAND_COUNT 2
#define USER__ADC_POLL_COMMAND_COUNT \
((USER__ADC_POLL_SERVICE_COMMAND_COUNT + USER__ADC_POLL_DATA_LENGTH) * USER__SW_COUNT)
